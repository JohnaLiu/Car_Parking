...
public class Driver_Control extends JFrame implements ActionListener  {
	...
	ArrayList<Staff_Account> mylist3=new ArrayList<Staff_Account>();	//Stack1, is for usage
	ArrayList<Public_Account> mylist4=new ArrayList<Public_Account>();	//Stack2, is for account
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					enterFrame.btnNewButton.addActionListener(new ActionListener(){
					    public void actionPerformed(ActionEvent evt) {
					    	...
					    	if(ticketcount==Car_Park.amount_of_tickets)
					    		...
					    		if(choose.addTicket==1)
								{
									...
									JOptionPane.showMessageDialog(null, "Sorry, There is no ticket. Operator fills in the ticket box.", "SORRY", JOptionPane.INFORMATION_MESSAGE);
					    	...
					    	{	pubTemp= mylist4.get(ticketcount);
					    		...
					    		pubTemp.payflag=1;
					    		JOptionPane.showMessageDialog(null, "Welcome, your ticket number is "+pubTemp.card_number, "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
					...
					enterFrame.txtReadCard.addActionListener(new ActionListener(){
					    public void actionPerformed(ActionEvent evt) {
					    	
					        IDInput = enterFrame.txtReadCard.getText().toString();
                    ...
                    System.out.println("Cannot find the file.");
					        ...
					        if(j==size)
					        {
					        	...
					        	JOptionPane.showMessageDialog(null, "You can't enter, you haven't registered.", "FAILURE", JOptionPane.ERROR_MESSAGE);
					        }
					        else
					        {
					        	Staff_Account findaccount=mylist3.get(j);
					        	if(findaccount.payflag==1)
					        		JOptionPane.showMessageDialog(null, "You can't enter, your last car usage had a problem.", "FAILURE", JOptionPane.ERROR_MESSAGE);
					        	else{
					        ...
					        JOptionPane.showMessageDialog(null, "Welcome"+findaccount.card_number, "SUCCESS", JOptionPane.INFORMATION_MESSAGE);
				...
				payFrame.textField_1.addActionListener(new ActionListener(){
						...
						public void actionPerformed(ActionEvent evt) {
					        ...
					        if(flag==0)   //no such a car in car park
					        	{JOptionPane.showMessageDialog(null, "Sorry, there is no such a car.", "SORRY", JOptionPane.ERROR_MESSAGE);
                 ...
                 else        //find the info of the car
                       {
                               ...
                               if(htemp.type==true)
                               {
                               Staff_Account findaccount=mylist3.get(htemp.accountlistnum);
                               ...
                               try{
                            	   fw = new FileWriter("usage_information.txt", true);   
                            	   bw = new BufferedWriter(fw);  
                            	   bw.newLine();
                               bw.write("\t"+htemp.id+"\t"+htemp.enter_time+"\t"+htemp.payment_time+"\t"+htemp.charge);
                               bw.close();
                               ...
                               payFrame.textArea.setText("Successfully out.\n This time your expense is  "+htemp.charge+".\n" +
                               		"Your account charge is "+mylist3.get(htemp.accountlistnum).accountCharge);
                               ...
                               if(htemp.type==false)
                               {
                            	   ...
                            	   payFrame.textArea.append(park.refreshPayment());
                            	   Public_Account paytemp=mylist4.get(htemp.accountlistnum);
...
/////////////////////////////////////////////////////////////////////////////////
                            	   ...
                            	   payFrame.textField_2.addActionListener(new ActionListener(){
                            		   ...
                            		   public void actionPerformed(ActionEvent evt) {
                            			   Public_Account transpaytemp=mylist4.get(accountNum);
                            			...
                            			{		
                            					...
                            					if (transhtemp.collection>=transhtemp.charge)
               					    	{
                            						transpaytemp.payflag=0;
                            						 BigDecimal a = new BigDecimal(transhtemp.collection);
                            						BigDecimal paidMoney = a.setScale(2, RoundingMode.DOWN);
                            				
                            						JOptionPane.showMessageDialog(null, "You have paid \u00A3 "+paidMoney, "Welcome", JOptionPane.INFORMATION_MESSAGE);
                            						...
                            						if (Car_Park.amount_of_coins>=Car_Park.max_money)
                            						{JOptionPane.showMessageDialog(null, "The money box is full, you have to collect the money.","Operator", JOptionPane.INFORMATION_MESSAGE);
                            						JOptionPane.showMessageDialog(null, "The money (\u00A3 "+Car_Park.amount_of_coins+") is taken away.","Operator", JOptionPane.INFORMATION_MESSAGE);
					...
					exitFrame.textField_1.addActionListener(new ActionListener(){
						...
						public void actionPerformed(ActionEvent evt) {
					        ...
					        leaveInput = exitFrame.textField_1.getText().toString();
					        ...
					        for(i=0;i<length;i++)
					        {
					        	...
					        	if(exit.payflag==0)
					        		exitFrame.txtrIdSParking.setText("Thank you for using our car park.");
					        	if(exit.payflag==1)
	...
	{
	        int s1=temp.payment_time.getSeconds()+temp.payment_time.getMinutes()*60+temp.payment_time.getHours()*3600+temp.payment_time.getDay()*216000;
	...
	public void push(Usage usage,LinkedList<Usage> mylist)//Ñ¹Õ»
	{
	        mylist.add(usage);
	}
	public Usage pop(LinkedList<Usage> mylist)  //µ¯Õ»
	{
	   Usage temp=new Usage();
	   if(mylist.size()!=0) {temp=(Usage)mylist.getLast(); mylist.removeLast();return (Usage)temp;}
	   else return null;
	}
	public boolean empty(LinkedList<Usage> mylist)//ÊÇ·ñÎª¿Õ
	{
